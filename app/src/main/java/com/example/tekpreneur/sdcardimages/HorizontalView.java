...
public class HorizontalView extends AdapterView {
 ...
 public HorizontalView(Context context, AttributeSet attrs) {
  ...
  public void setOnItemSelectedListener( AdapterView.OnItemSelectedListener listener) {
   ...
   @Override public void setOnItemLongClickListener( AdapterView.OnItemLongClickListener listener) {
   ...
   private DataSetObserver mDataObserver = new DataSetObserver() {
       ...
       @Override public void onInvalidated() {
           reset(); invalidate(); requestLayout();
       }
   };
   ...
   @Override public void setSelection(int position) {
    ...
    private void addAndMeasureChild(final View child, int viewPos) {
        ...
        child.measure( MeasureSpec.makeMeasureSpec(getWidth(),
                MeasureSpec.AT_MOST), MeasureSpec.makeMeasureSpec(getHeight(), MeasureSpec.AT_MOST));
    }

    @Override protected synchronized void onLayout(boolean changed, int left, int top, int right, int bottom) {
    ...
    private void positionItems(final int dx) {
        if (getChildCount() > 0) {
            mDisplayOffset += dx; int left = mDisplayOffset;
            ...
            for (int i = 0; i < getChildCount(); i++) {
                ...
                if (isEventWithinView(e, child)) {
                    if (mOnItemClicked != null) {
                        mOnItemClicked.onItemClick(HorizontalView.this,
